    ...
    beginner: {
      ...
      resources: {
        documentation: [
          ...
          { title: "AI Glossary", link: "https://www.ibm.com/cloud/learn/ai" },
    ...
    advanced: {
      ...
      resources: {
        documentation: [
          ...
          { title: "Vector Databases", link: "https://www.pinecone.io/learn/" },
        ],
    ...
    "web-development": {
      ...
      intermediate: [
        ...
        },
        {
          ...
          details: ["REST APIs", "Axios / Fetch", "Handling loading & errors"],
        },
        {
          step: 7,
 ...
 export const AIToolsData = [
  {
    ...
    "rating": 4.9,
    "pricing": "Freemium",
    "category": ["Educational Technology (EdTech)", "Artificial Intelligence", "Information Technology"],
    "whatItDoes": "AI-powered idea mapping and conceptual visualization tool.",
    "howToUse": ["Add your idea", "Generate AI mind maps", "Organize concepts", "Export visual output"],
    "techRelevance": ["Artificial Intelligence", "Information Technology", "Computer Science / Software Development"],
  ...
  },
  {
    ...
    "rating": 4.9,
    "pricing": "Freemium",
    "category": ["Information Technology", "Artificial Intelligence", "Educational Technology (EdTech)"],
    "whatItDoes": "AI meeting transcription and summary tool.",
    "howToUse": ["Start meeting", "Enable transcription", "Review notes", "Export summary"],
  ...
  },
  {
    ...
    "pricing": "Freemium",
    "category": ["Educational Technology (EdTech)", "Artificial Intelligence", "Information Technology"],
    "whatItDoes": "AI research assistant to upload, summarize & analyze documents.",
    "howToUse": ["Upload PDFs", "Ask questions", "Generate summaries", "Organize research"],
    "techRelevance": ["Artificial Intelligence", "Data Science"],
  ...
  },
  {
    ...
    "howToUse": ["Choose template", "Enter content", "AI creates slides", "Export project"],
  ...
  },
  {
    ...
    "rating": 4.9,
    "pricing": "Freemium",
    "category": ["Information Technology", "Artificial Intelligence", "Cloud Computing"],
    "whatItDoes": "Automated AI meeting recorder and summarizer.",
    "howToUse": ["Start or schedule meeting", "Enable AI assist", "Generate transcript", "Download summary"],
    "techRelevance": ["Artificial Intelligence", "Data Science"],
  ...
  },
  {
    ...
    "rating": 4.9,
    "pricing": "Freemium",
    "category": ["Artificial Intelligence", "Information Technology", "Data Science"],
    "whatItDoes": "AI-powered search engine with cited answers.",
    "howToUse": ["Type question", "Check cited sources", "Explore results", "Save threads"],
    "techRelevance": ["Artificial Intelligence", "Data Science"],
  ...
  },
  {
    ...
    "rating": 4.9,
    "pricing": "Freemium",
    "category": ["Media & Entertainment Technology", "Artificial Intelligence", "Educational Technology (EdTech)"],
    "whatItDoes": "Text‑to‑video AI generator.",
    "howToUse": ["Enter prompt", "Select style", "Generate video", "Refine output"],
    "techRelevance": ["Artificial Intelligence", "Computer Science / Software Development"],
  ...
  },
  {
    ...
    "rating": 4.9,
    "pricing": "Freemium",
    "category": ["Artificial Intelligence", "Information Technology", "Web Development"],
  ...
  },
  {
    ...
    "rating": 4.9,
    "pricing": "Freemium",
    "category": ["Artificial Intelligence", "Computer Science / Software Development", "Information Technology"],
    "whatItDoes": "Next‑gen conversational AI model for creative tasks.",
    "howToUse": ["Write prompt", "Select settings", "Generate output", "Refine result"],
    "techRelevance": ["Artificial Intelligence", "Computer Science / Software Development"],
  ...
  },
  {
    ...
    "howToUse": ["Upload video", "Apply AI tools", "Auto captions", "Export file"],
    "techRelevance": ["Artificial Intelligence", "Web Development"],
...
,
  {
    ...
    "rating": 4.9,
    "pricing": "Freemium",
    "category": ["Educational Technology (EdTech)", "Artificial Intelligence", "Data Science"],
    "whatItDoes": "AI tool to summarize and explain scientific papers.",
    "howToUse": ["Upload paper", "AI explains", "Extract insights", "Save summary"],
    "techRelevance": ["Artificial Intelligence", "Data Science"],
  ...
  },
  {
    "id": 13,
    "name": "Explainium AI",
    "category": ["Educational Technology (EdTech)", "Artificial Intelligence", "Media & Entertainment Technology"],
    "whatItDoes": "AI that creates animated explainers and videos.",
    "howToUse": ["Enter topic", "Pick style", "Generate video", "Download"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology"],
  ...
  },
  {
    ...
    "howToUse": ["Ask question", "Upload files", "Generate output", "Review insights"],
    "techRelevance": ["Artificial Intelligence", "Computer Science / Software Development"],
  ...
  },
  {
    "id": 15,
    "name": "PopAI",
    "category": ["Information Technology", "Artificial Intelligence", "Media & Entertainment Technology"],
  ...
  },
  {
    ...
    "name": "Notion AI",
    "category": ["Information Technology", "Artificial Intelligence", "Educational Technology (EdTech)"],
    "whatItDoes": "AI assistant inside Notion for notes, summaries, tasks, and workflows.",
    "howToUse": ["Open Notion", "Use AI commands", "Generate output", "Organize workspace"],
    "techRelevance": ["Artificial Intelligence", "Computer Science / Software Development"],
  ...
  },
  {
    "id": 19,
    "name": "Final Round AI",
    "category": ["Artificial Intelligence", "Educational Technology (EdTech)", "Information Technology"],
    "whatItDoes": "AI interviewing assistant for creating resume screening and practice rounds.",
    "howToUse": ["Upload resume", "Practice interview Q&A", "Get feedback", "Improve skills"],
    "techRelevance": ["Artificial Intelligence", "Educational Technology (EdTech)"],
  ...
  },
  {
    ...
    "name": "Grok",
    "category": ["Artificial Intelligence", "Information Technology", "Web Development"],
    "whatItDoes": "AI chatbot and reasoning tool designed for real‑time research, answers, and insights.",
    "howToUse": ["Open Grok chatbot", "Ask any question", "Get AI answer", "Refine context"],
  ...
  },
  {
    ...
    "howToUse": ["Open TalkPal", "Choose language", "Practice conversation", "Review feedback"],
    "techRelevance": ["Artificial Intelligence", "Educational Technology (EdTech)"],
  ...
  },
  {
    "id": 22,
    "name": "Taskade",
    "category": ["Information Technology", "Artificial Intelligence", "Web Development"],
    "whatItDoes": "AI task manager and team collaboration platform with smart workflows.", 
    "howToUse": ["Create workspace", "Add tasks", "Use AI templates", "Track progress"],
    "techRelevance": ["Artificial Intelligence", "Web Development"],
  ...
  },
  {
    "id": 23,
    "name": "mailmestro",
    "category": ["Information Technology", "Artificial Intelligence", "Productivity Tools"],
    "whatItDoes": "AI mail assistant for automated composing and email management.",
    "howToUse": ["Connect mailbox", "Enable AI suggestions", "Compose emails", "Organize inbox"],
    "techRelevance": ["Artificial Intelligence", "Information Technology"],
  ...
  },
  {
    ...
    "name": "Browse AI",
    "category": ["Artificial Intelligence", "Information Technology", "Web Development"],
    "whatItDoes": "AI web automation and data extraction tool for scraping and monitoring websites.",
    "howToUse": ["Define target pages", "Train AI bot", "Extract & monitor data", "Export results"],
    "techRelevance": ["Artificial Intelligence", "Information Technology"],
  ...
  },
  {
    ...
    "name": "teamsmestro",
    "category": ["Information Technology", "Artificial Intelligence", "Web Development"],
    "whatItDoes": "AI assistant for smart team scheduling, tasks and collaboration.",
    "howToUse": ["Create team", "Assign tasks", "Use AI suggestions", "Track workflows"],
    "techRelevance": ["Artificial Intelligence", "Web Development"],
  ...
  },
  {
    "id": 26,
    "name": "Replit",
    "category": ["Computer Science / Software Development", "Artificial Intelligence", "Web Development"],
    "whatItDoes": "Cloud coding platform with AI code generation, editing, and deployment.",
    "howToUse": ["Create new project", "Use AI coding assistant", "Run code online", "Deploy result"],
    "techRelevance": ["Artificial Intelligence", "Web Development", "Software Development"],
    "image": "https://source.unsplash.com/800x600/?coding",
  ...
  },
  {
    "id": 27,
    "name": "Friday AI",
    "category": ["Artificial Intelligence", "Information Technology", "Productivity Tools"],
    "whatItDoes": "AI workspace organizer for tasks, notes and scheduling boosts productivity.",
    "howToUse": ["Sign in", "Sync calendar", "Create tasks", "Use AI suggestions"],
    "techRelevance": ["Artificial Intelligence", "Information Technology"],
  ...
  },
  {
    ...
    "name": "Snipd",
    "category": ["Educational Technology (EdTech)", "Artificial Intelligence", "Media & Entertainment Technology"],
    "whatItDoes": "AI podcast summarizer and clipping tool for highlights and notes.",
    "howToUse": ["Import podcast", "Generate highlights", "Save notes", "Share summary"],
    "techRelevance": ["Artificial Intelligence", "Educational Technology (EdTech)"],
  ...
  },
  {
    ...
    "name": "Grain",
    "category": ["Information Technology", "Artificial Intelligence", "Media & Entertainment Technology"],
    "whatItDoes": "AI meeting recorder and clip tool for capturing highlights from calls.",
    "howToUse": ["Start recording", "Highlight key moments", "Generate clips", "Share snippets"],
    "techRelevance": ["Artificial Intelligence", "Information Technology"],
  ...
  },
  {
    "id": 30,
    "name": "Fluig AI",
    "category": ["Artificial Intelligence", "Information Technology", "Cloud Computing"],
    "whatItDoes": "AI tool for automatic workflow generation and automation tasks.",
    "howToUse": ["Define workflow", "Set triggers", "Activate AI", "Monitor execution"],
    "techRelevance": ["Artificial Intelligence", "Information Technology"],
    "image": "https://source.unsplash.com/800x600/?automation",
    "officialLink": "N/A",
    "docLink": "N/A",
...
,
  {
    ...
    "howToUse": ["Create workspace", "Add tasks", "Enable AI features", "Track goals"],
    "techRelevance": ["Artificial Intelligence", "Information Technology"],
  ...
  },
  {
    "id": 32,
    "name": "Memorae.ai",
    "category": ["Artificial Intelligence", "Information Technology", "Educational Technology (EdTech)"],
    "whatItDoes": "AI knowledge assistant to organize notes and reminders intelligently.",
    "howToUse": ["Add notes", "Enable AI suggestions", "Search knowledge", "Sync devices"],
    "techRelevance": ["Artificial Intelligence", "Information Technology"],
  ...
  },
  {
    "id": 33,
    "name": "Grid AI",
    "category": ["Artificial Intelligence", "Computer Science / Software Development", "Data Science"],
    "whatItDoes": "AI model platform for training, experimenting, and deploying AI models.",
  ...
  },
  {
    "id": 34,
    "name": "Bricks",
    "category": ["Artificial Intelligence", "Web Development", "Automation & Control Systems"],
  ...
  },
  {
    "id": 35,
    "name": "Lovable.ai",
    "category": ["Artificial Intelligence", "Media & Entertainment Technology", "Design & Creativity"],
    "whatItDoes": "AI design and creative tools to generate visuals and concepts.", 
    "howToUse": ["Enter prompt", "Select style", "Generate art", "Export creative"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology"],
  ...
  },
  {
    ...
    "name": "Fireflies",
    "category": ["Information Technology", "Artificial Intelligence", "Productivity Tools"],
    "whatItDoes": "AI meeting note taker that records, transcribes and summarizes calls.",
    "howToUse": ["Start meeting", "Enable Fireflies AI", "Save notes", "Export summary"],
    "techRelevance": ["Artificial Intelligence", "Information Technology"],
  ...
  },
  {
    "id": 37,
    "name": "Cursor",
    "category": ["Artificial Intelligence", "Computer Science / Software Development", "Web Development"],
    "whatItDoes": "AI coding platform with agent‑based workflows and automated coding tasks.", 
    "howToUse": ["Open Cursor", "Enter code prompt", "Generate or fix code", "Deploy output"],
    "techRelevance": ["Artificial Intelligence", "Computer Science / Software Development"],
  ...
  },
  {
    ...
    "name": "AutoDraw",
    "category": ["Artificial Intelligence", "Media & Entertainment Technology", "Design & Creativity"],
    "whatItDoes": "AI sketching tool that turns rough doodles into polished drawings.", 
    "howToUse": ["Start drawing", "Let AI recognize shapes", "Adjust output", "Export art"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology"],
...
,
  
  {
    "id": 39,
    "name": "GitHub",
    "category": ["Information Technology", "Web Development", "Computer Science / Software Development", "Cloud Computing"],
    "whatItDoes": "Platform for version control, collaboration, and hosting code repositories.",
    "howToUse": ["Create account", "Initialize repo", "Push code", "Collaborate with team"],
    "techRelevance": ["Web Development", "Computer Science / Software Development", "Cloud Computing"],
  ...
  },
  {
    "id": 40,
    "name": "Make.com",
    "category": ["Information Technology", "Automation & Control Systems", "Web Development", "Artificial Intelligence"],
    "whatItDoes": "AI-powered workflow automation platform to connect apps and automate tasks.",
    "howToUse": ["Sign up", "Create scenario", "Connect apps", "Run automation"],
    "techRelevance": ["Automation & Control Systems", "Web Development", "Artificial Intelligence"],
    "image": "https://source.unsplash.com/800x600/?automation",
  ...
  },
  {
    "id": 41,
    "name": "n8n",
    "category": ["Information Technology", "Automation & Control Systems", "Web Development", "Cloud Computing"],
    "whatItDoes": "Open-source workflow automation tool with integrations for multiple apps.",
    "howToUse": ["Install n8n", "Create workflow", "Add nodes", "Run automation"],
    "techRelevance": ["Automation & Control Systems", "Web Development", "Cloud Computing"],
    "image": "https://source.unsplash.com/800x600/?workflow",
  ...
  },
  {
    ...
    "name": "Zapier",
    "category": ["Information Technology", "Automation & Control Systems", "Web Development", "Cloud Computing"],
    "whatItDoes": "Platform to automate workflows by connecting multiple apps without code.",
    "howToUse": ["Sign up", "Choose app triggers", "Add actions", "Run automation"],
    "techRelevance": ["Automation & Control Systems", "Web Development", "Cloud Computing"],
  ...
  },
  {
    ...
    "howToUse": ["Login", "Define workflow", "Use AI suggestions", "Export results"],
    "techRelevance": ["Artificial Intelligence", "Automation & Control Systems", "Web Development"],
  ...
  },
  {
    ...
    "name": "Remio",
    "category": ["Information Technology", "Artificial Intelligence", "Media & Entertainment Technology"],
    "whatItDoes": "AI-powered video creation and editing platform for marketing and social media.",
    "howToUse": ["Sign in", "Upload content", "Use AI tools", "Export video"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology", "Web Development"],
    "image": "https://source.unsplash.com/800x600/?video-editing",
  ...
  },
  {
    ...
    "name": "Cluely",
    "category": ["Artificial Intelligence", "Information Technology", "Educational Technology (EdTech)"],
    "whatItDoes": "AI assistant for learning and research, helping users organize and summarize content.",
    "howToUse": ["Upload content", "Ask AI questions", "Get summarized notes", "Export summaries"],
    "techRelevance": ["Artificial Intelligence", "Educational Technology (EdTech)", "Information Technology"],
  ...
  },
  {
    ...
    "category": ["Artificial Intelligence", "Information Technology", "Machine Learning", "Data Science"],
    "whatItDoes": "Google's AI platform for building, testing, and deploying machine learning models.",
    "howToUse": ["Login", "Create project", "Train model", "Deploy solution"],
    "techRelevance": ["Artificial Intelligence", "Machine Learning", "Data Science", "Cloud Computing"],
  ...
  },
  {
    "id": 47,
    "name": "Captions",
    "category": ["Artificial Intelligence", "Media & Entertainment Technology", "Web Development"],
    "whatItDoes": "AI tool to automatically generate captions for videos and social media content.",
    "howToUse": ["Upload video", "Generate captions", "Edit if needed", "Download/export"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology"],
  ...
  },
  {
    "id": 48,
    "name": "Zing Data",
    "category": ["Data Science", "Artificial Intelligence", "Information Technology"],
    "whatItDoes": "AI-driven data analytics and visualization platform for business intelligence.",
    "howToUse": ["Upload datasets", "Analyze with AI", "Generate visualizations", "Export reports"],
    "techRelevance": ["Data Science", "Artificial Intelligence", "Web Development"],
  ...
  },
  {
    ...
    "name": "Canvamagic",
    "category": ["Artificial Intelligence", "Media & Entertainment Technology", "Web Development"],
    "whatItDoes": "AI design assistant integrated with Canva to create visual content automatically.",
    "howToUse": ["Login to Canva", "Enable Canvamagic AI", "Generate design", "Customize and export"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology", "Web Development"],
  ...
  },
  {
    ...
    "whatItDoes": "AI platform for transforming scripts and articles into engaging videos.",
    "howToUse": ["Input text/script", "Select video style", "Generate video", "Edit & export"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology"],
  ...
  },
  {
    "id": 51,
    "name": "Eleven Labs",
    "category": ["Artificial Intelligence", "Media & Entertainment Technology", "Educational Technology (EdTech)"],
    "whatItDoes": "AI text-to-speech platform producing realistic voices for content creation.",
    "howToUse": ["Input text", "Select voice", "Generate audio", "Download/export"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology"],
  ...
  },
  {
    ...
    "name": "Heygen",
    "category": ["Artificial Intelligence", "Media & Entertainment Technology"],
    "whatItDoes": "AI video generation platform to create lifelike avatars for videos and presentations.",
    "howToUse": ["Create avatar", "Add script or voice", "Generate video", "Download/export"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology", "Web Development"],
  ...
  },
  {
    ...
    "category": ["Artificial Intelligence", "Media & Entertainment Technology"],
    "whatItDoes": "AI platform for creating consistent digital characters for storytelling and gaming.",
    "howToUse": ["Create character", "Train personality", "Generate interactions", "Export outputs"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology", "Educational Technology (EdTech)"],
  ...
  },
  {
    ...
    "name": "Descript",
    "category": ["Artificial Intelligence", "Media & Entertainment Technology", "Educational Technology (EdTech)"],
    "whatItDoes": "AI-powered video and audio editing platform with transcription and collaboration features.",
    "howToUse": ["Upload media", "Edit with AI tools", "Add subtitles", "Export content"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology"],
    "image": "https://source.unsplash.com/800x600/?video-editing",
  ...
  },
  {
    "id": 55,
    "name": "Headspace AI",
    "category": ["Artificial Intelligence", "Medical & Health Technology", "Educational Technology (EdTech)"],
    "whatItDoes": "AI-assisted mindfulness and meditation platform for mental well-being.",
    "howToUse": ["Sign up", "Choose meditation plan", "Follow AI guidance", "Track progress"],
  ...
  },
  {
    ...
    "name": "Rewind",
    "category": ["Artificial Intelligence", "Information Technology", "Productivity Tools"],
    "whatItDoes": "AI tool for automatically recording, indexing, and searching your computer activities.",
    "howToUse": ["Install Rewind", "Enable recording", "Search activities", "Retrieve information"],
    "techRelevance": ["Artificial Intelligence", "Information Technology", "Web Development"],
  ...
  },
  {
    ...
    "howToUse": ["Open Feedough", "Search company/startup", "Get insights", "Export report"],
    "techRelevance": ["Artificial Intelligence", "Data Science", "Information Technology"],
  ...
  },
  {
    "id": 58,
    "name": "Miro",
    "category": ["Information Technology", "Educational Technology (EdTech)", "Web Development"],
    "whatItDoes": "Online collaborative whiteboard platform with AI features.",
    "howToUse": ["Create board", "Add AI widgets", "Collaborate with team", "Export board"],
    "techRelevance": ["Information Technology", "Web Development", "Educational Technology (EdTech)"],
  ...
  },
  {
    ...
    "name": "Grammarly",
    "category": ["Artificial Intelligence", "Information Technology", "Educational Technology (EdTech)"],
    "whatItDoes": "AI-powered writing assistant for grammar, style, and tone improvements.",
    "howToUse": ["Install Grammarly", "Write text", "Get suggestions", "Apply corrections"],
    "techRelevance": ["Artificial Intelligence", "Educational Technology (EdTech)"],
    "image": "https://source.unsplash.com/800x600/?writing",
  ...
  },
  {
    "id": 60,
    "name": "Brain FM",
    "category": ["Artificial Intelligence", "Media & Entertainment Technology", "Medical & Health Technology"],
    "whatItDoes": "AI-generated music for focus, relaxation, and sleep.",
    "howToUse": ["Open Brain FM", "Select purpose", "Play music", "Adjust settings"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology", "Medical & Health Technology"],
  ...
  },
  {
    ...
    "name": "Airtable AI",
    "category": ["Information Technology", "Artificial Intelligence", "Cloud Computing"],
    "whatItDoes": "AI-powered database assistant for automating workflows and managing data.",
    "howToUse": ["Open Airtable", "Add AI assistant", "Automate workflows", "Analyze data"],
    "techRelevance": ["Artificial Intelligence", "Information Technology", "Cloud Computing"],
  ...
  },
  {
    "id": 62,
    "name": "Llama",
    "category": ["Artificial Intelligence", "Machine Learning", "Information Technology"],
    "whatItDoes": "Open-source large language model for research and AI applications.",
    "howToUse": ["Download model", "Integrate into project", "Run prompts", "Analyze output"],
    "techRelevance": ["Artificial Intelligence", "Machine Learning", "Computer Science / Software Development"],
    "image": "https://source.unsplash.com/800x600/?ai-model",
  ...
  },
  {
    ...
    "howToUse": ["Open YesChat", "Start conversation", "Ask questions", "Get AI responses"],
    "techRelevance": ["Artificial Intelligence", "Information Technology"],
    "image": "https://source.unsplash.com/800x600/?chatbot",
    "officialLink": "N/A",
    "docLink": "N/A",
  ...
  },
  {
    "id": 64,
    "name": "Synthesia AI",
    "category": ["Media & Entertainment Technology", "Educational Technology (EdTech)", "Artificial Intelligence"],
    "whatItDoes": "AI video generation platform to create professional videos from text.",
    "howToUse": ["Enter script", "Choose avatar", "Generate video", "Export content"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology", "Educational Technology (EdTech)"],
  ...
  },
  {
    "id": 65,
    "name": "Branche AI",
    "category": ["Artificial Intelligence", "Financial Technology (FinTech)", "Web Development"],
    "whatItDoes": "AI tool for analyzing financial data and investment insights.",
    "howToUse": ["Connect data source", "Run analysis", "Generate insights", "Export report"],
    "techRelevance": ["Artificial Intelligence", "Financial Technology (FinTech)"],
  ...
  },
  {
    "id": 66,
    "name": "Visme",
    "category": ["Media & Entertainment Technology", "Educational Technology (EdTech)", "Web Development"],
    "whatItDoes": "AI-powered platform for creating presentations, infographics, and visual content.",
    "howToUse": ["Choose template", "Add content", "Apply AI design", "Export visuals"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology", "Web Development"],
  ...
  },
  {
    "id": 67,
    "name": "Gemma",
    "category": ["Educational Technology (EdTech)", "Media & Entertainment Technology", "Artificial Intelligence"],
    "whatItDoes": "AI tool for content creation, learning, and interactive tutorials.",
    "howToUse": ["Enter content", "Select style", "Generate output", "Use for learning"],
    "techRelevance": ["Artificial Intelligence", "Educational Technology (EdTech)"],
    "image": "https://source.unsplash.com/800x600/?learning",
    "officialLink": "N/A",
    "docLink": "N/A",
  ...
  },
  {
    ...
    "name": "Nano Banana",
    "category": ["Artificial Intelligence", "Media & Entertainment Technology", "Web Development"],
    "whatItDoes": "AI design tool for creating graphics, animations, and digital assets.",
    "howToUse": ["Enter prompt", "Select template", "Generate design", "Export output"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology"],
    "image": "https://source.unsplash.com/800x600/?design",
    "officialLink": "N/A",
    "docLink": "N/A",
  ...
  },
  {
    "id": 69,
    "name": "Ideogram",
    "category": ["Artificial Intelligence", "Media & Entertainment Technology", "Computer Science / Software Development"],
    "whatItDoes": "AI platform to generate visual diagrams and conceptual illustrations from text.",
    "howToUse": ["Input text", "Select style", "Generate diagram", "Download"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology", "Computer Science / Software Development"],
  ...
  },
  {
    ...
    "name": "Seedream",
    "category": ["Artificial Intelligence", "Media & Entertainment Technology", "Web Development"],
    "whatItDoes": "AI tool for generating creative visuals and concept art from prompts.",
    "howToUse": ["Enter prompt", "Select style", "Generate image", "Export creative assets"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology"],
  ...
  },
  {
    ...
    "category": ["Educational Technology (EdTech)", "Media & Entertainment Technology", "Web Development"],
    "whatItDoes": "AI tool to create flowcharts, mind maps, and diagrams collaboratively.",
    "howToUse": ["Create diagram", "Add elements", "Apply AI suggestions", "Export output"],
    "techRelevance": ["Artificial Intelligence", "Educational Technology (EdTech)", "Media & Entertainment Technology"],
    "image": "https://source.unsplash.com/800x600/?diagram",
  ...
  },
  {
    ...
    "name": "Quizlet",
    "category": ["Educational Technology (EdTech)", "Artificial Intelligence", "Information Technology"],
    "whatItDoes": "AI-powered learning platform for flashcards, quizzes, and study tools.",
    "howToUse": ["Create set", "Add content", "Use AI suggestions", "Study and test"],
    "techRelevance": ["Artificial Intelligence", "Educational Technology (EdTech)"],
  ...
  },
  {
    ...
    "howToUse": ["Connect calendar", "Set preferences", "AI schedule suggestions", "Sync events"],
    "techRelevance": ["Artificial Intelligence", "Information Technology"],
    "image": "https://source.unsplash.com/800x600/?calendar",
  ...
  },
  {
    ...
    "whatItDoes": "AI-powered task and time management tool to optimize productivity.",
    "howToUse": ["Create workspace", "Add tasks", "Enable AI features", "Track progress"],
    "techRelevance": ["Artificial Intelligence", "Information Technology"],
    "image": "https://source.unsplash.com/800x600/?productivity",
  ...
  },
  {
    "id": 75,
    "name": "Trevor AI",
    "category": ["Artificial Intelligence", "Productivity", "Mobile App Development"],
    "whatItDoes": "AI calendar and productivity assistant for personal and team management.",
    "howToUse": ["Connect calendar", "Create tasks", "Use AI assistant", "Track schedule"],
  ...
  },
  {
    ...
    "howToUse": ["Enter product details", "Select tone/style", "Generate hooks", "Export content"],
  ...
  },
  {
    ...
    "howToUse": ["Choose template", "Add content", "Use AI design", "Export presentation"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology", "Web Development"],
    "image": "https://source.unsplash.com/800x600/?presentation",
  ...
  },
  {
    "id": 78,
    "name": "Syllaby",
    "category": ["Educational Technology (EdTech)", "Artificial Intelligence", "Information Technology", "Web Development"],
    "whatItDoes": "AI tool for creating interactive learning content and syllabi quickly.",
    "howToUse": ["Select course topic", "Generate syllabus", "Customize content", "Export and share"],
    "techRelevance": ["Artificial Intelligence", "Educational Technology (EdTech)", "Web Development"],
  ...
  },
  {
    ...
    "category": ["Information Technology", "Artificial Intelligence", "Web Development"],
    "whatItDoes": "AI tool to automatically generate pinned comments for videos, blogs, or posts.",
    "howToUse": ["Connect account", "Generate comment", "Customize output", "Pin it on platform"],
    "techRelevance": ["Artificial Intelligence", "Information Technology"],
  ...
  },
  {
    ...
    "howToUse": ["Upload video", "Analyze audience", "Generate insights", "Share or embed"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology"],
    "image": "https://source.unsplash.com/800x600/?video",
  ...
  },
  {
    ...
    "howToUse": ["Upload footage", "Enable AI edits", "Review result", "Export final video"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology"],
    "image": "https://source.unsplash.com/800x600/?video-editing",
  ...
  },
  {
    ...
    "name": "Invideo AI",
    "category": ["Media & Entertainment Technology", "Artificial Intelligence", "Web Development"],
    "whatItDoes": "AI-powered video creation and editing platform for marketing content.",
    "howToUse": ["Select template", "Add content", "AI generates video", "Export project"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology"],
    "image": "https://source.unsplash.com/800x600/?video-creation",
  ...
  },
  {
    ...
    "name": "King AI",
    "category": ["Artificial Intelligence", "Information Technology", "Web Development"],
    "whatItDoes": "AI assistant for automating workflows and generating insights.",
    "howToUse": ["Connect tools", "Define workflow", "Generate AI output", "Review results"],
    "techRelevance": ["Artificial Intelligence", "Information Technology"],
  ...
  },
  {
    ...
    "name": "ICAI GPT",
    "category": ["Educational Technology (EdTech)", "Artificial Intelligence", "Information Technology"],
    "whatItDoes": "AI assistant for accounting and finance professionals to answer queries and generate content.",
    "howToUse": ["Ask question", "Upload files", "Generate answer", "Save or export output"],
    "techRelevance": ["Artificial Intelligence", "Educational Technology (EdTech)"],
    "image": "https://source.unsplash.com/800x600/?finance",
    "officialLink": "N/A",
    "docLink": "N/A",
  ...
  },
  {
    ...
    "name": "Design",
    "category": ["Media & Entertainment Technology", "Artificial Intelligence", "Web Development"],
    "whatItDoes": "AI-powered tool for generating designs, templates, and visuals.",
    "howToUse": ["Enter design prompt", "Select style", "Generate output", "Download design"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology"],
    "image": "https://source.unsplash.com/800x600/?design",
    "officialLink": "N/A",
    "docLink": "N/A",
  ...
  },
  {
    "id": 86,
    "name": "Framer",
    "category": ["Web Development", "Artificial Intelligence", "Media & Entertainment Technology"],
    "whatItDoes": "AI-powered web and UI prototyping tool.",
    "howToUse": ["Create prototype", "Add AI interactions", "Preview design", "Export project"],
    "techRelevance": ["Artificial Intelligence", "Web Development"],
  ...
  },
  {
    ...
    "name": "Lindy",
    "category": ["Educational Technology (EdTech)", "Artificial Intelligence", "Information Technology"],
    "whatItDoes": "AI tool to organize learning resources and track study progress.",
    "howToUse": ["Add courses", "Generate study plan", "Track progress", "Review insights"],
    "techRelevance": ["Artificial Intelligence", "Educational Technology (EdTech)"],
    "image": "https://source.unsplash.com/800x600/?learning",
    "officialLink": "N/A",
    "docLink": "N/A",
  ...
  },
  {
    ...
    "howToUse": ["Upload media", "Select enhancement", "Apply AI", "Download output"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology"],
  ...
  },
  {
    ...
    "howToUse": ["Choose template", "Enter content", "Generate AI slides", "Export deck"],
    "techRelevance": ["Artificial Intelligence", "Media & Entertainment Technology"],
    "image": "https://source.unsplash.com/800x600/?presentation",
  ...
  },
  {
    ...
    "howToUse": ["Upload dataset", "Generate charts", "Customize visuals", "Export results"],
    "techRelevance": ["Artificial Intelligence", "Data Science", "Web Development"],
  ...
  },
  {
    ...
    "name": "Julius",
    "category": ["Artificial Intelligence", "Educational Technology (EdTech)", "Information Technology"],
    "whatItDoes": "AI assistant for voice interactions, transcription, and productivity tasks.",
    "howToUse": ["Record audio", "Generate transcription", "Ask queries", "Export results"],
    "techRelevance": ["Artificial Intelligence", "Educational Technology (EdTech)"],
  ...
  },
  {
    "id": 92,
    "name": "Darktrace",
    "category": ["Cybersecurity", "Artificial Intelligence", "Information Technology"],
    "whatItDoes": "AI-driven threat detection and network monitoring.",
    "howToUse": ["Deploy Darktrace agent", "Monitor network traffic", "AI detects threats", "Review insights and alerts"],
    "techRelevance": ["Artificial Intelligence", "Cybersecurity", "Computer Science / Software Development"],
  ...
  },
  {
    ...
    "howToUse": ["Install Falcon agent", "Monitor endpoints", "AI detects malware", "Respond to threats"],
    "techRelevance": ["Artificial Intelligence", "Cybersecurity", "Computer Science / Software Development"],
    "image": "https://source.unsplash.com/800x600/?cybersecurity,ai",
  ...
  },
  {
    ...
    "howToUse": ["Install Cylance software", "Run AI scan", "Detect threats", "Prevent attacks"],
    "techRelevance": ["Artificial Intelligence", "Cybersecurity", "Computer Science / Software Development"],
    "image": "https://source.unsplash.com/800x600/?cybersecurity,ai",
  ...
  },
  {
    ...
    "howToUse": ["Deploy Vectra sensors", "Monitor network", "AI detects anomalies", "Respond to incidents"],
    "techRelevance": ["Artificial Intelligence", "Cybersecurity", "Computer Science / Software Development"],
    "image": "https://source.unsplash.com/800x600/?cybersecurity,ai",
  ...
  },
  {
    ...
    "howToUse": ["Install Sophos Intercept X", "Enable AI protection", "Monitor devices", "Respond to threats"],
    "techRelevance": ["Artificial Intelligence", "Cybersecurity", "Computer Science / Software Development"],
    "image": "https://source.unsplash.com/800x600/?cybersecurity,ai",
  ...
  },
  {
    ...
    "category": ["Cybersecurity", "Artificial Intelligence", "Information Technology"],
    "whatItDoes": "Security information and event management (SIEM) with AI insights.",
    "howToUse": ["Deploy Splunk", "Ingest security logs", "Use AI modules", "Analyze alerts"],
  ...
  },
  {
    ...
    "howToUse": ["Integrate QRadar", "Collect security data", "Use Watson AI for analysis", "Respond to incidents"],
    "techRelevance": ["Artificial Intelligence", "Cybersecurity", "Computer Science / Software Development"],
    "image": "https://source.unsplash.com/800x600/?cybersecurity,ai",
  ...
  },
  {
    ...
    "howToUse": ["Integrate with logs", "Monitor user activity", "AI detects anomalies", "Investigate threats"],
    "techRelevance": ["Artificial Intelligence", "Cybersecurity", "Computer Science / Software Development"],
    "image": "https://source.unsplash.com/800x600/?cybersecurity,ai",
  ...
  },
  {
    ...
    "name": "FireEye Helix",
    "category": ["Cybersecurity", "Artificial Intelligence", "Information Technology"],
    "whatItDoes": "AI-driven security operations platform for threat detection and response.",
    "howToUse": ["Deploy FireEye Helix", "Collect security events", "AI analyzes threats", "Respond to incidents"],
    "techRelevance": ["Artificial Intelligence", "Cybersecurity", "Computer Science / Software Development"],
    "image": "https://source.unsplash.com/800x600/?cybersecurity,ai",
  ...
  },
  {
    ...
    "howToUse": ["Deploy LogRhythm", "Collect logs", "Use AI for analysis", "Respond to alerts"],
    "techRelevance": ["Artificial Intelligence", "Cybersecurity", "Computer Science / Software Development"],
    "image": "https://source.unsplash.com/800x600/?cybersecurity,ai",
  ...
  },
  {
    "id": 102,
    "name": "ThingWorx",
    "category": ["Internet of Things (IoT)", "Artificial Intelligence", "Cloud Computing"],
    "whatItDoes": "AI-driven IoT platform for smart device management and analytics.",
    "howToUse": ["Connect IoT devices", "Analyze device data", "Generate insights", "Automate actions"],
  ...
  },
  {
    "id": 103,
    "name": "C3 AI IoT",
    "category": ["Internet of Things (IoT)", "Artificial Intelligence", "Enterprise Software"],
    "whatItDoes": "Enterprise AI platform for IoT applications and predictive maintenance.",
    "howToUse": ["Connect IoT devices", "Apply AI models", "Predict failures", "Optimize operations"],
  ...
  },
  {
    ...
    "category": ["Internet of Things (IoT)", "Cloud Computing", "Artificial Intelligence"],
    "whatItDoes": "Analyze IoT device data using AI/ML on AWS cloud platform.",
    "howToUse": ["Ingest IoT data", "Run AI/ML analytics", "Visualize insights", "Trigger actions"],
  ...
  },
  {
    ...
    "howToUse": ["Register devices", "Monitor data", "Analyze with AI", "Generate reports"],
    "techRelevance": ["IoT", "AI", "Cloud Computing", "Data Science"],
    "image": "https://source.unsplash.com/800x600/?IoT",
  ...
  },
  {
    ...
    "category": ["Internet of Things (IoT)", "Cloud Computing", "Artificial Intelligence"],
    "whatItDoes": "Microsoft AI-enabled IoT platform for monitoring and analytics.",
    "howToUse": ["Connect IoT devices", "Visualize data", "Apply AI insights", "Automate processes"],
    "techRelevance": ["IoT", "AI", "Cloud Computing", "Data Science"],
    "image": "https://source.unsplash.com/800x600/?IoT",
  ...
  },
  {
    ...
    "category": ["Internet of Things (IoT)", "Artificial Intelligence", "Industrial Technology"],
    "whatItDoes": "Industrial IoT platform using AI for predictive analytics and operations.",
    "howToUse": ["Connect industrial devices", "Analyze operational data", "Predict maintenance", "Optimize production"],
    "techRelevance": ["IoT", "AI", "Industrial Technology", "Predictive Analytics"],
    "image": "https://source.unsplash.com/800x600/?IoT",
  ...
  },
  {
    ...
    "howToUse": ["Connect assets", "Collect data", "Analyze with AI", "Optimize performance"],
    "techRelevance": ["IoT", "AI", "Industrial Technology", "Predictive Analytics"],
    "image": "https://source.unsplash.com/800x600/?IoT",
  ...
  },
  {
    ...
    "howToUse": ["Connect devices", "Ingest IoT data", "Analyze with AI", "Automate actions"],
    "techRelevance": ["IoT", "AI", "Cloud Computing", "Data Science"],
    "image": "https://source.unsplash.com/800x600/?IoT",
  ...
  },
  {
    "id": 110,
    "name": "FogHorn",
    "category": ["Internet of Things (IoT)", "Artificial Intelligence", "Edge Computing"],
    "whatItDoes": "Edge AI platform for real-time IoT analytics and processing.",
    "howToUse": ["Deploy at edge", "Collect sensor data", "Analyze with AI", "Trigger real-time actions"],
  ...
  },
  {
    ...
    "name": "PTC Kepware",
    "category": ["Internet of Things (IoT)", "Artificial Intelligence", "Industrial Technology"],
    "whatItDoes": "IoT connectivity platform integrated with AI-based predictive tools for industrial automation.",
    "howToUse": ["Connect industrial devices", "Integrate AI models", "Monitor operations", "Optimize processes"],
  ...
  },
  {
    "id": 112,
    "name": "RoboDK",
    "category": ["Robotics", "Artificial Intelligence", "Computer Science / Software Development"],
    "whatItDoes": "Offline programming and simulation software for industrial robots.",
    "howToUse": ["Select robot", "Simulate tasks", "Generate code", "Deploy to robot"],
  ...
  },
  {
    ...
    "whatItDoes": "Toolkit for developing and comparing reinforcement learning algorithms for robotics.",
    "howToUse": ["Set up environment", "Train AI agent", "Simulate tasks", "Evaluate performance"],
  ...
  },
  {
    ...
    "category": ["Robotics", "Artificial Intelligence", "Computer Science / Software Development"],
    "whatItDoes": "Open-source framework for robot software development and AI integration.",
    "howToUse": ["Install ROS", "Write nodes", "Integrate AI models", "Run robot simulations"],
    "techRelevance": ["Robotics", "AI", "Automation & Control Systems"],
  ...
  },
  {
    ...
    "category": ["Robotics", "Artificial Intelligence", "Educational Technology (EdTech)"],
    "whatItDoes": "AI-enabled robotics kits and programming tools for education and research.",
    "howToUse": ["Assemble robot", "Program AI tasks", "Test in simulation", "Deploy robot"],
  ...
  },
  {
    ...
    "whatItDoes": "Collaborative AI robots for industrial automation and smart manufacturing.",
    "howToUse": ["Deploy robot", "Train AI behaviors", "Monitor tasks", "Optimize processes"],
  ...
  },
  {
    ...
    "category": ["Robotics", "Artificial Intelligence", "Automation & Control Systems"],
    "whatItDoes": "AI for advanced robotics mobility, perception, and autonomy.",
    "howToUse": ["Program motion", "Train AI models", "Test navigation", "Deploy autonomous robots"],
    "techRelevance": ["Robotics", "AI", "Automation & Control Systems"],
  ...
  },
  {
    ...
    "name": "NVIDIA Isaac",
    "category": ["Robotics", "Artificial Intelligence", "Computer Science / Software Development"],
    "whatItDoes": "AI platform for robotics simulation, training, and deployment with GPU acceleration.",
    "howToUse": ["Set up simulator", "Train AI agents", "Test in virtual environment", "Deploy to physical robots"],
  ...
  },
  {
    ...
    "category": ["Robotics", "Artificial Intelligence", "Industrial Technology"],
    "whatItDoes": "AI-enabled autonomous mobile robots for logistics and warehousing.",
    "howToUse": ["Deploy robots", "Monitor AI tasks", "Optimize routes", "Analyze performance"],
    "techRelevance": ["Robotics", "AI", "Industrial Technology", "Logistics Automation"],
  ...
  },
  {
    ...
    "category": ["Robotics", "Artificial Intelligence", "Industrial Technology"],
    "whatItDoes": "AI-powered industrial robots for assembly, welding, and automation.",
    "howToUse": ["Program robot", "Train AI models", "Monitor tasks", "Optimize production"],
    "techRelevance": ["Robotics", "AI", "Industrial Technology", "Automation & Control Systems"],
  ...
  },
  {
    ...
    "category": ["Blockchain", "Artificial Intelligence", "Cybersecurity", "Financial Technology (FinTech)"],
    "whatItDoes": "Real-time AI-powered transaction monitoring and compliance for blockchain networks.",
    "howToUse": ["Connect blockchain wallet", "Monitor transactions", "Flag suspicious activity", "Generate reports"],
  ...
  },
  {
    "id": 122,
    "name": "Covalent AI",
    "category": ["Blockchain", "Artificial Intelligence", "Data Science", "Financial Technology (FinTech)"],
    "whatItDoes": "AI-based analytics platform providing unified blockchain data for apps and research.",
    "howToUse": ["Connect blockchain APIs", "Query data", "Analyze trends", "Integrate insights"],
  ...
  },
  {
    "id": 123,
    "name": "Numerai",
    "category": ["Blockchain", "Artificial Intelligence", "Machine Learning", "Financial Technology (FinTech)"],
    "whatItDoes": "AI-driven hedge fund powered by blockchain-based data science competitions.",
    "howToUse": ["Submit ML models", "Evaluate predictions", "Stake NMR tokens", "Earn rewards"],
  ...
  },
  {
    ...
    "category": ["Blockchain", "Artificial Intelligence", "Cloud Computing", "Machine Learning"],
    "whatItDoes": "Decentralized AI computing platform using blockchain for AI training cost optimization.",
    "howToUse": ["Deploy AI tasks", "Connect blockchain nodes", "Train AI models", "Monitor usage"],
  ...
  },
  {
    "id": 125,
    "name": "SingularityNET",
    "category": ["Blockchain", "Artificial Intelligence", "Decentralized AI", "Machine Learning"],
    "whatItDoes": "AI marketplace powered by blockchain for decentralized AI services and models.",
    "howToUse": ["Browse AI services", "Purchase with AGI token", "Integrate APIs", "Deploy AI solutions"],
    "techRelevance": ["Blockchain", "AI", "Machine Learning", "Decentralized Systems"],
  ...
  },
  {
    "id": 126,
    "name": "Velas AI",
    "category": ["Blockchain", "Artificial Intelligence", "Smart Contracts", "Machine Learning"],
    "whatItDoes": "AI-powered blockchain platform for smart contract optimization and autonomous decision-making.",
    "howToUse": ["Deploy smart contracts", "Enable AI optimization", "Monitor performance", "Automate tasks"],
  ...
  },
  {
    "id": 127,
    "name": "Cortex AI",
    "category": ["Blockchain", "Artificial Intelligence", "Machine Learning", "Computer Science / Software Development"],
    "whatItDoes": "Decentralized AI platform on blockchain for deploying AI models and DApps.",
    "howToUse": ["Upload AI models", "Deploy on blockchain", "Monitor AI inference", "Earn rewards"],
  ...
  },
  {
    "id": 128,
    "name": "Fetch.ai",
    "category": ["Blockchain", "Artificial Intelligence", "Internet of Things (IoT)", "Machine Learning"],
    "whatItDoes": "Autonomous AI agents on blockchain for IoT, finance, and optimization tasks.",
    "howToUse": ["Deploy AI agents", "Connect IoT devices", "Perform autonomous tasks", "Analyze outcomes"],
  ...
  },
  {
    "id": 129,
    "name": "Ocean Protocol",
    "category": ["Blockchain", "Artificial Intelligence", "Data Science", "Machine Learning"],
    "whatItDoes": "Blockchain-based AI data marketplace for sharing and monetizing datasets securely.",
    "howToUse": ["Publish datasets", "Access datasets via smart contracts", "Train AI models", "Analyze results"],
  ...
  },
  {
    ...
    "name": "AIChain",
    "category": ["Blockchain", "Artificial Intelligence", "Machine Learning", "Computer Science / Software Development"],
    "whatItDoes": "Platform for integrating AI models with blockchain for analytics, predictions, and smart contracts.",
    "howToUse": ["Deploy AI on blockchain", "Train predictive models", "Integrate smart contracts", "Generate insights"],
  ...
  },
  {
    "id": 131,
    "name": "Atomwise",
    "category": ["Biotechnology", "Artificial Intelligence", "Machine Learning", "Medical & Health Technology"],
    "whatItDoes": "AI-driven drug discovery platform using deep learning to predict molecular binding.",
    "howToUse": ["Input target protein", "Run AI model", "Analyze predicted molecules", "Select candidates"],
    "techRelevance": ["AI", "Machine Learning", "Biotechnology", "Drug Discovery"],
  ...
  },
  {
    "id": 132,
    "name": "Benchling",
    "category": ["Biotechnology", "Artificial Intelligence", "Data Science", "Medical & Health Technology"],
    "whatItDoes": "Cloud-based platform for life sciences R&D with AI-powered data analysis and workflow automation.",
    "howToUse": ["Upload experimental data", "Use AI insights", "Collaborate with team", "Track results"],
  ...
  },
  {
    ...
    "howToUse": ["Upload biological data", "Run AI algorithms", "Analyze predictions", "Select candidate compounds"],
    "techRelevance": ["Biotechnology", "AI", "Machine Learning", "Drug Discovery"],
  ...
  },
  {
    ...
    "category": ["Biotechnology", "Artificial Intelligence", "Data Science", "Medical & Health Technology"],
    "whatItDoes": "AI and machine learning platform for high-throughput cellular imaging and drug discovery.",
    "howToUse": ["Input cellular data", "Run AI analysis", "Identify phenotypes", "Generate drug candidates"],
    "techRelevance": ["Biotechnology", "AI", "Machine Learning", "Drug Discovery"],
  ...
  },
  {
    ...
    "name": "Deep Genomics",
    "category": ["Biotechnology", "Artificial Intelligence", "Machine Learning", "Medical & Health Technology"],
    "whatItDoes": "AI platform for genetic medicine development by predicting how genetic variants affect disease.",
    "howToUse": ["Input genomic data", "Run AI prediction", "Analyze therapeutic targets", "Develop treatments"],
  ...
  },
  {
    ...
    "name": "BenevolentAI",
    "category": ["Biotechnology", "Artificial Intelligence", "Machine Learning", "Medical & Health Technology"],
    "whatItDoes": "AI-powered drug discovery and development platform to accelerate pharmaceutical research.",
    "howToUse": ["Input target disease", "Run AI analysis", "Predict drug candidates", "Optimize compounds"],
  ...
  },
  {
    ...
    "name": "Exscientia",
    "category": ["Biotechnology", "Artificial Intelligence", "Machine Learning", "Medical & Health Technology"],
    "whatItDoes": "AI-driven drug design platform optimizing small molecule development for speed and efficiency.",
    "howToUse": ["Define target protein", "Run AI optimization", "Select compounds", "Proceed to trials"],
  ...
  },
  {
    ...
    "category": ["Biotechnology", "Artificial Intelligence", "Machine Learning", "Medical & Health Technology"],
    "whatItDoes": "AI-assisted drug discovery platform targeting neurological and psychiatric disorders.",
    "howToUse": ["Input data", "Analyze via AI", "Identify drug candidates", "Move to clinical trials"],
    "techRelevance": ["Biotechnology", "AI", "Machine Learning", "Drug Discovery"],
  ...
  },
  {
    ...
    "name": "Insitro",
    "category": ["Biotechnology", "Artificial Intelligence", "Machine Learning", "Medical & Health Technology"],
    "whatItDoes": "AI-driven platform integrating biology and machine learning for drug discovery and disease modeling.",
    "howToUse": ["Input biological datasets", "Run AI models", "Analyze predictions", "Select therapeutic candidates"],
    "techRelevance": ["Biotechnology", "AI", "Machine Learning", "Drug Discovery"],
  ...
  },
  {
    "id": 140,
    "name": "Zymergen",
    "category": ["Biotechnology", "Artificial Intelligence", "Automation & Control Systems", "Clean / Green Technology"],
    "whatItDoes": "AI-powered platform for bio-manufacturing, optimizing molecular design and materials production.",
    "howToUse": ["Input design parameters", "Run AI simulations", "Analyze molecular outputs", "Scale production"],
  ...
  },
  {
    ...
    "category": ["Environmental Technology", "Artificial Intelligence", "Data Science", "Cloud Computing"],
    "whatItDoes": "AI-driven platform for weather, climate risk, and environmental event predictions.",
    "howToUse": ["Input location data", "Analyze environmental risks", "Generate AI insights", "Plan mitigation strategies"],
    "techRelevance": ["Environmental Technology", "AI", "Data Science", "Cloud Computing"],
    "image": "https://source.unsplash.com/800x600/?environment",
    "officialLink": "https://www.ibm.com/products/environmental-intelligence-suite",
  ...
  },
  {
    "id": 142,
    "name": "Descartes Labs",
    "category": ["Environmental Technology", "Artificial Intelligence", "Machine Learning", "Remote Sensing"],
    "whatItDoes": "AI-powered geospatial analytics platform for environmental monitoring and predictive modeling.",
    "howToUse": ["Upload satellite imagery", "Run AI analysis", "Interpret results", "Plan interventions"],
    "techRelevance": ["Environmental Technology", "AI", "Machine Learning", "Remote Sensing"],
  ...
  },
  {
    ...
    "name": "Climate AI",
    "category": ["Environmental Technology", "Artificial Intelligence", "Data Science", "Cloud Computing"],
    "whatItDoes": "AI platform predicting climate risks and enabling resilient planning for agriculture and infrastructure.",
    "howToUse": ["Input environmental data", "Run AI models", "Analyze risks", "Generate mitigation plans"],
    "techRelevance": ["Environmental Technology", "AI", "Data Science", "Cloud Computing"],
  ...
  },
  {
    "id": 144,
    "name": "Pachama",
    "category": ["Environmental Technology", "Artificial Intelligence", "Remote Sensing", "Data Science"],
    "whatItDoes": "AI-powered forest monitoring platform using satellite and drone data for carbon offset verification.",
    "howToUse": ["Upload drone/satellite data", "Run AI analysis", "Monitor forest health", "Generate carbon reports"],
    "techRelevance": ["Environmental Technology", "AI", "Data Science", "Remote Sensing"],
  ...
  },
  {
    ...
    "category": ["Environmental Technology", "Artificial Intelligence", "Clean / Green Technology"],
    "whatItDoes": "AI-driven carbon capture monitoring and optimization platform.",
    "howToUse": ["Connect capture facility", "Analyze CO2 data", "Optimize capture efficiency", "Generate reports"],
    "techRelevance": ["Environmental Technology", "AI", "Clean Technology", "Data Science"],
  ...
  },
  {
    "id": 146,
    "name": "Airly",
    "category": ["Environmental Technology", "Artificial Intelligence", "IoT", "Data Science"],
    "whatItDoes": "AI-powered air quality monitoring using IoT sensors and predictive modeling.",
    "howToUse": ["Deploy sensors", "Collect real-time data", "Run AI predictions", "Generate insights/reports"],
  ...
  },
  {
    ...
    "category": ["Environmental Technology", "Artificial Intelligence", "Data Science", "Climate Risk Management"],
    "whatItDoes": "AI platform assessing climate risks to infrastructure, agriculture, and urban planning.",
    "howToUse": ["Input environmental data", "Run AI models", "Evaluate risks", "Generate mitigation plans"],
    "techRelevance": ["Environmental Technology", "AI", "Data Science", "Risk Management"],
  ...
  },
  {
    "id": 148,
    "name": "Enview",
    "category": ["Environmental Technology", "Artificial Intelligence", "Remote Sensing", "IoT"],
    "whatItDoes": "AI-powered platform for monitoring environmental changes using satellite and drone imagery.",
    "howToUse": ["Upload imagery", "Run AI analysis", "Track changes", "Generate environmental reports"],
  ...
  },
  {
    "id": 149,
    "name": "Cloverly",
    "category": ["Environmental Technology", "Artificial Intelligence", "Clean / Green Technology", "Data Science"],
    "whatItDoes": "AI platform automating carbon offsetting for businesses with analytics and sustainability insights.",
    "howToUse": ["Connect business data", "Run AI analytics", "Calculate emissions", "Purchase offsets"],
    "techRelevance": ["Environmental Technology", "AI", "Clean Technology", "Data Science"],
  ...
  },
  {
    ...
    "category": ["Environmental Technology", "Artificial Intelligence", "Remote Sensing", "Cloud Computing"],
    "whatItDoes": "AI platform providing environmental monitoring, natural resource management, and predictive modeling.",
    "howToUse": ["Input geospatial data", "Run AI models", "Generate environmental insights", "Plan actions"],
    "techRelevance": ["Environmental Technology", "AI", "Remote Sensing", "Data Science"],
  ...
  },
  {
    ...
    "category": ["Space Technology", "Artificial Intelligence", "Data Science", "Remote Sensing"],
    "whatItDoes": "AI platform analyzing satellite imagery for space and earth observation insights.",
    "howToUse": ["Upload satellite images", "Run AI analysis", "Extract insights", "Generate reports"],
  ...
  },
  {
    "id": 152,
    "name": "LeoLabs",
    "category": ["Space Technology", "Artificial Intelligence", "IoT", "Data Science"],
    "whatItDoes": "AI-driven platform for tracking satellites and debris in Low Earth Orbit.",
    "howToUse": ["Connect tracking data", "Run AI models", "Monitor orbit objects", "Generate risk reports"],
  ...
  },
  {
    "id": 153,
    "name": "SpaceKnow",
    "category": ["Space Technology", "Artificial Intelligence", "Remote Sensing", "Data Science"],
    "whatItDoes": "AI platform for analyzing satellite imagery to monitor economic and environmental activities on Earth.",
    "howToUse": ["Upload satellite data", "Run AI analysis", "Extract patterns", "Generate actionable insights"],
  ...
  },
  {
    ...
    "category": ["Space Technology", "Artificial Intelligence", "Data Science", "Networking / Telecommunications"],
    "whatItDoes": "AI-powered space situational awareness platform for satellite tracking and orbital analysis.",
    "howToUse": ["Connect telemetry data", "Run AI algorithms", "Analyze satellite paths", "Generate alerts"],
    "techRelevance": ["Space Technology", "AI", "Data Science", "Networking / Telecommunications"],
  ...
  },
  {
    ...
    "category": ["Space Technology", "Artificial Intelligence", "IoT", "Data Science"],
    "whatItDoes": "AI platform for analyzing satellite communications, sensor data, and space operations.",
    "howToUse": ["Upload sensor data", "Run AI analysis", "Monitor communications", "Generate reports"],
    "techRelevance": ["Space Technology", "AI", "IoT", "Data Science"],
  ...
  },
  {
    "id": 156,
    "name": "Upstream Tech",
    "category": ["Space Technology", "Artificial Intelligence", "Remote Sensing", "Environmental Technology"],
    "whatItDoes": "AI-powered satellite analytics for monitoring water, environmental changes, and land use from space.",
    "howToUse": ["Upload satellite imagery", "Run AI models", "Extract environmental insights", "Generate reports"],
    "techRelevance": ["Space Technology", "AI", "Remote Sensing", "Environmental Technology"],
  ...
  },
  {
    ...
    "category": ["Space Technology", "Artificial Intelligence", "Robotics", "Data Science"],
    "whatItDoes": "AI simulation and analysis tool for spacecraft trajectory, orbital mechanics, and mission planning.",
    "howToUse": ["Input spacecraft parameters", "Run AI simulations", "Analyze trajectory", "Generate mission plans"],
  ...
  },
  {
    ...
    "category": ["Space Technology", "Artificial Intelligence", "Robotics", "Data Science"],
    "whatItDoes": "AI-enhanced simulation and modeling platform for satellite missions, space situational awareness, and orbital analysis.",
    "howToUse": ["Setup satellite models", "Run AI analysis", "Simulate missions", "Generate reports"],
    "techRelevance": ["Space Technology", "AI", "Robotics", "Data Science"],
  ...
  },
  {
    ...
    "name": "Spire Global",
    "category": ["Space Technology", "Artificial Intelligence", "IoT", "Data Science"],
    "whatItDoes": "AI-driven satellite constellation for tracking weather, ships, and global environmental data.",
    "howToUse": ["Access satellite feeds", "Run AI models", "Analyze data", "Generate insights"],
    "techRelevance": ["Space Technology", "AI", "IoT", "Data Science"],
  ...
  },
  {
    ...
    "name": "Astro Digital",
    "category": ["Space Technology", "Artificial Intelligence", "Remote Sensing", "Data Science"],
    "whatItDoes": "AI-powered Earth observation platform analyzing satellite imagery for climate, environmental, and resource management.",
    "howToUse": ["Upload satellite images", "Run AI analysis", "Extract insights", "Generate actionable reports"],
    "techRelevance": ["Space Technology", "AI", "Remote Sensing", "Data Science"],
  ...
  },
  {
    "id": 161,
    "name": "Prospera",
    "category": ["Agricultural Technology", "Artificial Intelligence", "Data Science", "IoT"],
    "whatItDoes": "AI platform for monitoring crops, analyzing growth patterns, and predicting yield.",
    "howToUse": ["Install sensors", "Collect field data", "Run AI analysis", "Generate insights and reports"],
  ...
  },
  {
    "id": 162,
    "name": "Taranis",
    "category": ["Agricultural Technology", "Artificial Intelligence", "Remote Sensing", "Data Science"],
    "whatItDoes": "AI-driven crop intelligence platform using aerial imagery to detect disease, pests, and nutrient deficiencies.",
    "howToUse": ["Collect drone imagery", "Upload to platform", "Run AI analysis", "Take action based on insights"],
    "techRelevance": ["Agricultural Technology", "AI", "Remote Sensing", "Data Science"],
  ...
  },
  {
    ...
    "category": ["Agricultural Technology", "Artificial Intelligence", "Robotics", "IoT"],
    "whatItDoes": "AI-powered precision agriculture robotics for selective spraying and weed control.",
    "howToUse": ["Deploy robotic sprayer", "Enable AI targeting", "Monitor operation", "Adjust settings"],
    ...
    "tutorialLink": "https://www.deere.com/en/technology-products/see-and-spray/learning",
    "githubLink": "N/A"
  },
  {
    "id": 164,
    "name": "CropX",
    "category": ["Agricultural Technology", "Artificial Intelligence", "IoT", "Data Science"],
    "whatItDoes": "AI-based soil sensing and irrigation optimization platform.",
    "howToUse": ["Install soil sensors", "Collect moisture data", "Run AI recommendations", "Adjust irrigation systems"],
    "techRelevance": ["Agricultural Technology", "AI", "IoT", "Data Science"],
  ...
  },
  {
    ...
    "category": ["Agricultural Technology", "Artificial Intelligence", "Data Science", "IoT"],
    "whatItDoes": "AI solutions for smart farming, crop health monitoring, and automated farming decisions.",
    "howToUse": ["Deploy IoT devices", "Collect farm data", "Run AI analysis", "Receive actionable insights"],
    "techRelevance": ["Agricultural Technology", "AI", "IoT", "Data Science"],
  ...
  },
  {
    "id": 166,
    "name": "Plantix",
    "category": ["Agricultural Technology", "Artificial Intelligence", "Mobile App Development", "Data Science"],
    "whatItDoes": "AI-powered mobile app for plant disease detection and management.",
    "howToUse": ["Take plant photo", "Upload to app", "Run AI diagnosis", "Follow treatment recommendations"],
    "techRelevance": ["Agricultural Technology", "AI", "Mobile App Development", "Data Science"],
  ...
  },
  {
    "id": 167,
    "name": "eAgronom",
    "category": ["Agricultural Technology", "Artificial Intelligence", "Data Science", "Cloud Computing"],
    "whatItDoes": "AI-based farm management software with yield forecasting, planning, and resource optimization.",
    "howToUse": ["Input farm data", "Run AI analysis", "Optimize resources", "Track performance"],
    "techRelevance": ["Agricultural Technology", "AI", "Data Science", "Cloud Computing"],
  ...
  },
  {
    ...
    "name": "PEAT",
    "category": ["Agricultural Technology", "Artificial Intelligence", "Mobile App Development", "Data Science"],
    "whatItDoes": "AI mobile app for plant health diagnosis and pest detection using image recognition.",
    "howToUse": ["Take plant image", "Upload to app", "AI identifies disease", "Apply recommendations"],
    "techRelevance": ["Agricultural Technology", "AI", "Mobile App Development", "Data Science"],
  ...
  },
  {
    ...
    "name": "Gamaya",
    "category": ["Agricultural Technology", "Artificial Intelligence", "Remote Sensing", "Data Science"],
    "whatItDoes": "AI drone platform for crop monitoring, nutrient mapping, and pest management.",
    "howToUse": ["Fly drones over fields", "Collect multispectral data", "Run AI analysis", "Generate insights"],
    "techRelevance": ["Agricultural Technology", "AI", "Remote Sensing", "Data Science"],
  ...
  },
  {
    ...
    "name": "Arable",
    "category": ["Agricultural Technology", "Artificial Intelligence", "IoT", "Data Science"],
    "whatItDoes": "AI platform with IoT sensors for microclimate monitoring, crop prediction, and irrigation optimization.",
    "howToUse": ["Install Arable sensors", "Collect environmental data", "Run AI models", "Adjust farming decisions"],
    "techRelevance": ["Agricultural Technology", "AI", "IoT", "Data Science"],
  ...
  },
  {
    ...
    "category": ["Networking / Telecommunications", "Artificial Intelligence", "Cloud Computing"],
    "whatItDoes": "AI-driven WiFi and network performance management platform for enterprises.",
    "howToUse": ["Deploy network devices", "Enable AI monitoring", "Analyze network performance", "Optimize WiFi and routing"],
  ...
  },
  {
    ...
    "category": ["Networking / Telecommunications", "Artificial Intelligence", "Cybersecurity", "Cloud Computing"],
    "whatItDoes": "AI-powered network management, automation, and assurance platform.",
    "howToUse": ["Integrate network devices", "Enable AI analytics", "Monitor network health", "Automate configurations"],
    "techRelevance": ["Networking / Telecommunications", "AI", "Cybersecurity", "Cloud Computing"],
    "image": "https://source.unsplash.com/800x600/?network",
    "officialLink": "https://www.cisco.com/c/en/us/products/cloud-systems-management/dna-center/index.html",
    "docLink": "https://www.cisco.com/c/en/us/td/docs/dna-center/",
    "tutorialLink": "https://www.cisco.com/c/en/us/td/docs/dna-center/tutorials.html",
    "githubLink": "N/A"
  },
  {
    "id": 173,
    "name": "Juniper Mist AI",
    "category": ["Networking / Telecommunications", "Artificial Intelligence", "Cloud Computing", "IoT"],
    "whatItDoes": "AI-driven network operations for wireless and wired networks with insights and anomaly detection.",
    "howToUse": ["Connect network devices", "Enable Mist AI", "Monitor network", "Analyze insights"],
    "techRelevance": ["Networking / Telecommunications", "AI", "Cloud Computing", "IoT"],
    "image": "https://source.unsplash.com/800x600/?telecom",
    "officialLink": "https://www.juniper.net/us/en/products-services/mist-ai.html",
  ...
  },
  {
    "id": 174,
    "name": "NetBrain",
    "category": ["Networking / Telecommunications", "Artificial Intelligence", "Data Science"],
    "whatItDoes": "Network automation and mapping platform using AI for troubleshooting and insights.",
    "howToUse": ["Discover network", "Generate network maps", "Enable AI analytics", "Resolve issues automatically"],
  ...
  },
  {
    "id": 175,
    "name": "HPE Aruba ESP",
    "category": ["Networking / Telecommunications", "Artificial Intelligence", "IoT", "Cloud Computing"],
    "whatItDoes": "AI-powered networking platform for automation, assurance, and security.",
    "howToUse": ["Deploy Aruba devices", "Enable AI insights", "Monitor network health", "Optimize performance"],
    "techRelevance": ["Networking / Telecommunications", "AI", "IoT", "Cloud Computing"],
  ...
  },
  {
    ...
    "category": ["Networking / Telecommunications", "Artificial Intelligence", "Cloud Computing", "Cybersecurity"],
    "whatItDoes": "AI-driven analytics platform for network operations and performance monitoring.",
    "howToUse": ["Deploy network devices", "Enable ExtremeAI", "Collect metrics", "Generate insights"],
    "techRelevance": ["Networking / Telecommunications", "AI", "Cloud Computing", "Cybersecurity"],
  ...
  },
  {
    "id": 177,
    "name": "Segrata",
    "category": ["Networking / Telecommunications", "Artificial Intelligence", "Cybersecurity"],
    "whatItDoes": "AI-based security monitoring and threat detection for enterprise networks.",
    "howToUse": ["Integrate with network", "Enable AI threat detection", "Monitor events", "Generate alerts"],
  ...
  },
  {
    "id": 178,
    "name": "ExtraHop",
    "category": ["Networking / Telecommunications", "Artificial Intelligence", "Data Science", "Cybersecurity"],
    "whatItDoes": "AI-driven network detection and response platform to identify anomalies and threats.",
    "howToUse": ["Connect network", "Enable AI monitoring", "Analyze traffic", "Respond to anomalies"],
    "techRelevance": ["Networking / Telecommunications", "AI", "Data Science", "Cybersecurity"],
  ...
  },
  {
    "id": 179,
    "name": "Anuta Networks",
    "category": ["Networking / Telecommunications", "Artificial Intelligence", "Automation & Control Systems"],
    "whatItDoes": "AI-powered network automation and orchestration platform for enterprise networks.",
    "howToUse": ["Integrate network devices", "Configure workflows", "Enable AI automation", "Monitor performance"],
    "techRelevance": ["Networking / Telecommunications", "AI", "Automation & Control Systems"],
  ...
  },
  {
    "id": 180,
    "name": "NetScout",
    "category": ["Networking / Telecommunications", "Artificial Intelligence", "Data Science", "Cloud Computing"],
    "whatItDoes": "AI analytics platform for real-time network performance, anomaly detection, and monitoring.",
    "howToUse": ["Connect network devices", "Enable AI analytics", "Monitor performance", "Analyze insights"],
    "techRelevance": ["Networking / Telecommunications", "AI", "Data Science", "Cloud Computing"],
  ...
  },
  {
    "id": 181,
    "name": "Buildots",
    "category": ["Civil Engineering & Construction Technology", "Artificial Intelligence", "Automation & Control Systems"],
    "whatItDoes": "AI-powered construction site monitoring using computer vision and cameras to track progress.",
    "howToUse": ["Install cameras on site", "Enable AI tracking", "Monitor construction progress", "Generate insights and reports"],
    "techRelevance": ["Civil Engineering & Construction Technology", "AI", "Automation & Control Systems"],
  ...
  },
  {
    ...
    "name": "OpenSpace AI",
    "category": ["Civil Engineering & Construction Technology", "Artificial Intelligence", "Automation & Control Systems"],
    "whatItDoes": "AI solution for 360° photo documentation and construction site progress tracking.",
    "howToUse": ["Capture 360° images", "Upload to OpenSpace", "AI analyzes progress", "Track project milestones"],
    "techRelevance": ["Civil Engineering & Construction Technology", "AI", "Automation & Control Systems"],
  ...
  },
  {
    "id": 183,
    "name": "Doxel AI",
    "category": ["Civil Engineering & Construction Technology", "Artificial Intelligence", "Robotics"],
    "whatItDoes": "AI and robotics for automated construction progress tracking using LiDAR and cameras.",
    "howToUse": ["Deploy robotic camera system", "Scan construction site", "AI analyzes data", "Generate progress reports"],
    "techRelevance": ["Civil Engineering & Construction Technology", "AI", "Robotics"],
  ...
  },
  {
    ...
    "category": ["Civil Engineering & Construction Technology", "Artificial Intelligence", "Data Science"],
    "whatItDoes": "AI-based construction planning software to optimize scheduling and resource allocation.",
    "howToUse": ["Upload project plans", "Enable AI optimization", "Analyze schedule", "Adjust resources"],
    "techRelevance": ["Civil Engineering & Construction Technology", "AI", "Data Science"],
  ...
  },
  {
    "id": 185,
    "name": "Smartvid.io",
    "category": ["Civil Engineering & Construction Technology", "Artificial Intelligence", "Media & Entertainment Technology"],
    "whatItDoes": "AI platform for visual safety monitoring, risk detection, and progress tracking on construction sites.",
    "howToUse": ["Upload site images/videos", "Enable AI analysis", "Detect safety issues", "Generate reports"],
    "techRelevance": ["Civil Engineering & Construction Technology", "AI", "Media & Entertainment Technology"],
  ...
  },
  {
    ...
    "name": "Venture AI",
    "category": ["Civil Engineering & Construction Technology", "Artificial Intelligence", "Data Science"],
    "whatItDoes": "AI for predictive analytics in construction projects to prevent delays and cost overruns.",
    "howToUse": ["Input project data", "Enable AI predictions", "Analyze forecasts", "Optimize project management"],
    "techRelevance": ["Civil Engineering & Construction Technology", "AI", "Data Science"],
  ...
  },
  {
    ...
    "name": "Versatile.ai",
    "category": ["Civil Engineering & Construction Technology", "Artificial Intelligence", "Robotics"],
    "whatItDoes": "AI and robotics for automated site inspections, quality assurance, and progress tracking.",
    "howToUse": ["Deploy AI drones/robots", "Scan construction site", "Analyze collected data", "Generate reports"],
    "techRelevance": ["Civil Engineering & Construction Technology", "AI", "Robotics"],
  ...
  },
  {
    "id": 188,
    "name": "Indus.ai",
    "category": ["Civil Engineering & Construction Technology", "Artificial Intelligence", "Data Science", "Robotics"],
    "whatItDoes": "AI-powered construction monitoring platform using drones and computer vision for real-time insights.",
    "howToUse": ["Deploy drones on site", "Enable AI monitoring", "Collect images/videos", "Generate analytics reports"],
    "techRelevance": ["Civil Engineering & Construction Technology", "AI", "Data Science", "Robotics"],
  ...
  },
  {
    ...
    "name": "Deepomatic",
    "category": ["Civil Engineering & Construction Technology", "Artificial Intelligence", "Automation & Control Systems"],
    "whatItDoes": "AI computer vision platform for construction site automation, defect detection, and progress monitoring.",
    "howToUse": ["Install cameras", "Enable AI analysis", "Detect defects", "Generate progress dashboards"],
    "techRelevance": ["Civil Engineering & Construction Technology", "AI", "Automation & Control Systems"],
  ...
  },
  {
    "id": 190,
    "name": "Sablono",
    "category": ["Civil Engineering & Construction Technology", "Artificial Intelligence", "Data Science", "Automation & Control Systems"],
    "whatItDoes": "AI-based project management and monitoring platform for construction with predictive analytics.",
    "howToUse": ["Input project schedule", "Enable AI monitoring", "Analyze progress", "Optimize workflow"],
    "techRelevance": ["Civil Engineering & Construction Technology", "AI", "Data Science", "Automation & Control Systems"],
  ...
  },
  {
    "id": 191,
    "name": "AutoGrid",
    "category": ["Energy / Sustainable Technology", "Artificial Intelligence", "Data Science"],
    "whatItDoes": "AI platform for energy management, grid optimization, and predictive analytics for utilities.",
    "howToUse": ["Input energy data", "Enable AI predictions", "Analyze grid performance", "Optimize energy usage"],
    "techRelevance": ["Energy / Sustainable Technology", "Artificial Intelligence", "Data Science"],
  ...
  },
  {
    "id": 192,
    "name": "Uptake",
    "category": ["Energy / Sustainable Technology", "Artificial Intelligence", "Machine Learning"],
    "whatItDoes": "AI-driven predictive maintenance and analytics for energy assets and sustainable operations.",
    "howToUse": ["Upload asset data", "Enable AI analysis", "Monitor performance", "Generate maintenance insights"],
    "techRelevance": ["Energy / Sustainable Technology", "AI", "Machine Learning"],
  ...
  },
  {
    "id": 193,
    "name": "Verdigris",
    "category": ["Energy / Sustainable Technology", "Artificial Intelligence", "IoT"],
    "whatItDoes": "AI platform for smart building energy management, consumption analytics, and efficiency optimization.",
    "howToUse": ["Install IoT sensors", "Connect to Verdigris AI", "Analyze energy usage", "Optimize building performance"],
    "techRelevance": ["Energy / Sustainable Technology", "Artificial Intelligence", "IoT"],
  ...
  },
  {
    ...
    "name": "Grid4C",
    "category": ["Energy / Sustainable Technology", "Artificial Intelligence", "Data Science"],
    "whatItDoes": "AI-powered predictive analytics for energy consumption, load forecasting, and renewable integration.",
    "howToUse": ["Input consumption data", "Enable AI forecasting", "Analyze results", "Optimize grid operation"],
  ...
  },
  {
    ...
    "category": ["Energy / Sustainable Technology", "Artificial Intelligence", "Cloud Computing"],
    "whatItDoes": "AI platform for energy efficiency, predictive analytics, and emission reduction strategies.",
    "howToUse": ["Connect building/facility data", "Enable AI models", "Generate analytics", "Optimize energy consumption"],
  ...
  },
  {
    ...
    "name": "Sense",
    "category": ["Energy / Sustainable Technology", "Artificial Intelligence", "IoT"],
    "whatItDoes": "AI and IoT platform to monitor and optimize residential and commercial energy usage.",
    "howToUse": ["Install Sense monitor", "Connect to AI dashboard", "Analyze usage patterns", "Receive optimization suggestions"],
    "techRelevance": ["Energy / Sustainable Technology", "Artificial Intelligence", "IoT"],
  ...
  },
  {
    ...
    "name": "Enel X",
    "category": ["Energy / Sustainable Technology", "Artificial Intelligence", "Data Science"],
    "whatItDoes": "AI solutions for smart grids, energy storage, and predictive energy management.",
    "howToUse": ["Connect facility/grid data", "Enable AI analysis", "Monitor energy flows", "Optimize performance"],
    "techRelevance": ["Energy / Sustainable Technology", "Artificial Intelligence", "Data Science"],
  ...
  },
  {
    ...
    "name": "Verdant AI",
    "category": ["Energy / Sustainable Technology", "Artificial Intelligence", "Machine Learning"],
    "whatItDoes": "AI platform for optimizing renewable energy generation and reducing carbon footprint.",
    "howToUse": ["Upload generation data", "Enable AI optimization", "Analyze outputs", "Adjust operations"],
    "techRelevance": ["Energy / Sustainable Technology", "Artificial Intelligence", "Machine Learning"],
  ...
  },
  {
    "id": 199,
    "name": "Kahua",
    "category": ["Energy / Sustainable Technology", "Artificial Intelligence", "Automation & Control Systems"],
    "whatItDoes": "AI platform for monitoring and optimizing energy operations and sustainability workflows.",
    "howToUse": ["Connect facility data", "Enable AI monitoring", "Analyze results", "Generate reports"],
    "techRelevance": ["Energy / Sustainable Technology", "Artificial Intelligence", "Automation & Control Systems"],
  ...
  },
  {
    "id": 200,
    "name": "GridBright",
    "category": ["Energy / Sustainable Technology", "Artificial Intelligence", "Data Science", "Cloud Computing"],
    "whatItDoes": "AI software for predictive maintenance, load balancing, and energy distribution optimization.",
    "howToUse": ["Input grid data", "Enable AI models", "Analyze outputs", "Optimize energy flow"],
    "techRelevance": ["Energy / Sustainable Technology", "Artificial Intelligence", "Data Science", "Cloud Computing"],
  ...
  },
  {
    ...
    "category": ["Transportation Technology", "Autonomous Vehicles", "Computer Vision", "AI"],
    "whatItDoes": "Self-driving car AI system for navigation, perception and real-time decision-making.",
    "howToUse": ["Integrate vehicle sensors", "Load navigation dataset", "Enable self-driving mode", "Monitor AI decisions"],
  ...
  },
  {
    ...
    "whatItDoes": "Urban mobility AI for autonomous ride-hailing and self-driving navigation.",
    "howToUse": ["Connect to vehicle sensors", "Enable cruise mapping", "Run simulation mode", "Deploy autonomous mode"],
  ...
  },
  {
    "id": 222,
    "name": "NVIDIA Drive",
    "category": ["Transportation Technology", "AI Hardware", "Autonomous Vehicles"],
    "whatItDoes": "AI platform for perception, mapping, trajectory planning and self-driving simulation.",
    "howToUse": ["Install Drive SDK", "Load training datasets", "Enable ADAS models", "Deploy on vehicle hardware"],
  ...
  },
  {
    ...
    "whatItDoes": "AI-based driver assistance system with lane detection, smart navigation, and autopilot.",
    "howToUse": ["Activate vehicle autopilot", "Monitor dashboard data", "Enable Full Self Driving Beta", "Review safety alerts"],
  ...
  },
  {
    ...
    "whatItDoes": "Open-source ADAS AI providing lane-keeping, adaptive cruise, and vehicle automation.",
    "howToUse": ["Install OpenPilot hardware", "Pair with supported cars", "Load firmware", "Enable ADAS mode"],
  ...
  },
  {
    ...
    "whatItDoes": "Traffic analysis AI for predicting congestion and optimizing urban transport routes.",
    "howToUse": ["Upload traffic datasets", "Run route analysis", "Use prediction models", "Optimize traffic patterns"],
  ...
  },
  {
    ...
    "whatItDoes": "Real-time traffic prediction and smart routing system for navigation apps.",
    "howToUse": ["Integrate HERE API", "Enable traffic layers", "Run navigation models", "Analyze movement data"],
  ...
  },
  {
    ...
    "whatItDoes": "AI system for optimizing bus, metro and public transport routes and schedules.",
    "howToUse": ["Upload transport data", "Enable demand prediction", "Run route optimizer", "Deploy schedules"],
  ...
  },
  {
    ...
    "whatItDoes": "AI for rail automation, traffic control, predictive maintenance, and smart mobility.",
    "howToUse": ["Integrate rail data", "Enable predictive models", "Run smart routing", "Monitor IoT dashboards"],
  ...
  },
  {
    ...
    "whatItDoes": "AI for logistics planning, route optimization, and transportation scheduling.",
    "howToUse": ["Upload logistics data", "Run AI optimizer", "Improve delivery routes", "Monitor supply chain KPIs"],
  ...
  },
  {
    "id": 230,
    "name": "Siemens MindSphere",
    "category": ["Manufacturing / Industrial Technology", "IoT", "AI", "Cloud Computing"],
    "whatItDoes": "Industrial IoT platform for AI-driven analytics, predictive maintenance, and factory optimization.",
    "howToUse": ["Connect industrial machines", "Upload sensor data", "Run AI analytics", "Monitor dashboards"],
  ...
  },
  {
    ...
    "whatItDoes": "AI platform for asset performance management, analytics, and industrial automation.",
    "howToUse": ["Integrate machine data", "Enable predictive models", "Analyze equipment health", "Automate maintenance"],
  ...
  },
  {
    "id": 232,
    "name": "IBM Maximo",
    "category": ["Manufacturing / Industrial Technology", "Asset Management", "AI"],
    "whatItDoes": "AI-powered asset monitoring, predictive maintenance, and industrial automation.",
    "howToUse": ["Connect assets", "Enable Maximo Monitor", "Analyze data", "Automate asset lifecycle"],
  ...
  },
  {
    ...
    "whatItDoes": "AI-driven MES (Manufacturing Execution System) for real-time production monitoring and automation.",
    "howToUse": ["Connect production lines", "Monitor operations", "Run AI quality checks", "Optimize workflows"],
  ...
  },
  {
    ...
    "whatItDoes": "No-code industrial app builder with AI automation for production lines.",
    "howToUse": ["Build workflows", "Integrate sensors", "Use AI widgets", "Deploy to factory floor"],
  ...
  },
  {
    ...
    "whatItDoes": "AI platform for real-time manufacturing analytics and productivity optimization.",
    "howToUse": ["Connect machine data", "Enable real-time analytics", "Detect inefficiencies", "Optimize throughput"],
  ...
  },
  {
    "id": 236,
    "name": "Vanti AI",
    "category": ["Manufacturing / Industrial Technology", "Quality Control", "AI"],
    "whatItDoes": "AI platform for manufacturing defect detection and no-code quality prediction models.",
    "howToUse": ["Upload quality data", "Train AI model", "Detect defects", "Improve production"],
  ...
  },
  {
    ...
    "category": ["Manufacturing / Industrial Technology", "Computer Vision", "AI"],
    "whatItDoes": "Uses AI and computer vision to detect product defects and analyze assembly issues.",
    "howToUse": ["Install cameras", "Capture assembly line footage", "Run defect detection", "Analyze root causes"],
  ...
  },
  {
    ...
    "category": ["Manufacturing / Industrial Technology", "AI", "Process Optimization"],
    "whatItDoes": "AI for preventing production losses and optimizing industrial processes.",
    "howToUse": ["Upload process data", "Enable AI models", "Identify root-cause issues", "Optimize processes"],
  ...
  },
  {
    ...
    "whatItDoes": "AI-powered robotic process automation for repetitive industrial and manufacturing tasks.",
    "howToUse": ["Create automation bots", "Integrate workflows", "Enable AI decision-making", "Deploy to factory operations"],
  ...
  "whatItDoes": "AI-assisted quantum computing platform for running quantum circuits on real quantum hardware.",
  "howToUse": ["Create IBM Quantum account", "Build circuits with Qiskit", "Run on quantum simulator", "Deploy on real quantum devices"],
  "techRelevance": ["Quantum Computing", "Artificial Intelligence", "Machine Learning"],
...
},
{
  "id": 241,
  "name": "Google Cirq",
  "category": ["Quantum Computing", "Computer Science / Software Development", "Artificial Intelligence"],
  "whatItDoes": "Python framework for developing quantum algorithms and AI-enhanced quantum circuits.",
  "howToUse": ["Install Cirq", "Build quantum circuits", "Simulate using Google tools", "Run experiments"],
...
},
{
  ...
  "category": ["Quantum Computing", "Machine Learning", "Artificial Intelligence"],
  "whatItDoes": "Quantum machine learning library that blends classical and quantum neural networks.",
  "howToUse": ["Install Qiskit ML", "Load datasets", "Build QNN models", "Train and evaluate"],
...
},
{
  ...
  "category": ["Quantum Computing", "Machine Learning", "Artificial Intelligence"],
  "whatItDoes": "Hybrid quantum-classical ML framework for AI research & quantum deep learning.",
  "howToUse": ["Install PennyLane", "Create hybrid models", "Train QML networks", "Run on simulators or hardware"],
...
},
{
  "id": 244,
  "name": "Amazon Braket",
  "category": ["Quantum Computing", "Cloud Computing", "Artificial Intelligence"],
  "whatItDoes": "Quantum computing service to build, simulate, and run quantum algorithms on AWS.",
  "howToUse": ["Open AWS Braket", "Choose device", "Run circuits", "Analyze AI-based optimizations"],
...
},
{
  ...
  "category": ["Quantum Computing", "Machine Learning", "Artificial Intelligence"],
  "whatItDoes": "Quantum machine learning extension of TensorFlow for creating hybrid AI models.",
  "howToUse": ["Install TFQ", "Build hybrid circuits", "Train AI models", "Run experiments"],
...
},
{
  ...
  "whatItDoes": "Quantum annealer platform for optimization, routing, scheduling, and AI problem-solving.",
  "howToUse": ["Create account", "Use Ocean SDK", "Submit QUBO problems", "Analyze AI solutions"],
...
},
{
  ...
  "category": ["Quantum Computing", "Automation & Control Systems", "Artificial Intelligence"],
  "whatItDoes": "Enterprise AI + Quantum workflow platform for simulation and optimization.",
  "howToUse": ["Design workflow", "Choose quantum backend", "Run simulations", "Optimize AI output"],
...
},
{
  "id": 248,
  "name": "Rigetti Forest",
  "category": ["Quantum Computing", "Software Development", "Artificial Intelligence"],
  "whatItDoes": "Quantum SDK for running AI-driven circuits on Rigetti quantum processors.",
  "howToUse": ["Install pyQuil", "Write QASM programs", "Run on QVM", "Deploy on QPU"],
...
},
{
  "id": 249,
  "name": "Classiq",
  "category": ["Quantum Computing", "Artificial Intelligence", "Automation & Control Systems"],
  "whatItDoes": "AI-driven quantum circuit synthesis platform that automatically designs optimized quantum programs.",
  "howToUse": ["Define problem", "Generate circuit via AI", "Optimize", "Run on quantum backend"],
